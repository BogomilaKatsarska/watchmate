...
#1.StreamPlatforn -> #2.WatchList -> #3. Review
# We do the tests in this order because of the dependencies of the classes
...
class StreamPlatformTestCase(APITestCase):
    ...
    def test_streamplatform_create(self):
        ...
        response = self.client.post(reverse('streamplatform-list'), data) #TODO: check this page
    ...
    def test_streamplatform_individual_element(self):
...
class WatchListTestCase(APITestCase):
    ...
    def test_watchlist_individual_element(self):
